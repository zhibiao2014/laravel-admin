...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_jr' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_JR', 'localhost'),
            'port' => env('DB_PORT_JR', '3306'),
            'database' => env('DB_DATABASE_JR', 'forge'),
            'username' => env('DB_USERNAME_JR', 'forge'),
            'password' => env('DB_PASSWORD_JR', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => env('DB_PREFIX_JR', ''),
            'strict' => true,
            'engine' => null,
        ],
